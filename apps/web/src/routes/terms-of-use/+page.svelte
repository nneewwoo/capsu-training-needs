...
<div class="prose-2xl mx-auto w-full max-w-4xl py-16 max-lg:px-8">
  <div
    ...
    <h1>Terms of Use</h1>
    <p>By signing up or using the app, you agree to comply with these Terms.</p>

    <h2>1. Use of the App</h2>
    <ul>
      <li>
        You must be at least <strong>18</strong> years old to use this app.
      </li>
      <li>
        You agree to provide accurate and up-to-date information when signing
        up.
      </li>
    </ul>
    ...
    <p>
      ...
      <a
        href="/privacy-policy"
        class="text-blue-600 decoration-1 hover:underline">
        Privacy Policy
      </a>
      . You agree to our use of your data as outlined in the Privacy Policy.
    </p>
    ...
    <p>
      ...
      <a
        href="mailto:contact@capsu-training-needs.tech"
        class="text-blue-600 decoration-1 hover:underline">
        contact@capsu-training-needs.tech
      </a>
      .
    </p>
  </div>
